...
if(isset($_POST['submit']))
  {
   ...
   $infacad=$_POST['infacad'];
      ...
      $query.=mysqli_query($con, "insert   tblacademichistory(AlumnoID,NotaInicial,NotaSemestral,NotaAnual,PromedioNotas,InfoAcad)value('$vid','$ni','$ns','$nanual','$promno','$infacad')");
    if ($query) {
...
<html lang="en">
	<head>
		<title>Usuarios | Historial Academico</title>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Usuarios <span class="text-bold">Historial Academico</span></h5>
<?php
                               $vid=$_GET['viewid'];
